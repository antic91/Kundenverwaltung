...
<html lang="en">
        ...
        <?php foreach ($_SESSION["CustomersArray"] as $key => $customer): ?>
            <div class="CusstomerData displayFlex">
                ...
                <div class="childWrapper displayFlex">
                    <button type="button" onclick="clicked(<?php echo $customer['kun_id'];?>)" <?php if($customer["user_id"] != $_SESSION["userData"]["user_id"]){echo "disabled";}?>>Delete</button>
                    <button type="button" onclick="clickedEdit(<?php echo $customer['kun_id'];?>)"  <?php if($customer["user_id"] != $_SESSION["userData"]["user_id"]){echo "disabled";}?>>Edit</button>
                </div>
                
                <?php if($customer["user_id"] != $_SESSION["userData"]["user_id"]):?>
